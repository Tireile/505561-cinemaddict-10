...
render(siteHeaderElement, new ProfileComponent(cards), RenderPosition.BEFOREEND);

const siteMainElement = document.querySelector(`.main`);

const filters = generateFilters(cards);
render(siteMainElement, new StatisticComponent(filters), RenderPosition.BEFOREEND);

const filmsComponent = new FilmsComponent();
render(siteMainElement, filmsComponent, RenderPosition.BEFOREEND);

const controller = new PageController(filmsComponent);
controller.render(cards);
...
// render(filmsElement.getElement(), filmsListElement, RenderPosition.BEFOREEND);
...
// render(extraFilmElement, new ExtraComponent(`Top Rated`), RenderPosition.BEFOREEND);
// render(extraFilmElement, new ExtraComponent(`Most Commented`), RenderPosition.BEFOREEND);
